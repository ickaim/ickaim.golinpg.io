...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2018 at 10:22 PM
...
INSERT INTO `about_us` (`about_us_id`, `category_id`, `about_us_image`, `about_us_title`, `about_us_content`) VALUES
(1, 4, 'krug1.png', 'EXPLORERS', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. '),
(2, 4, 'krug2.png', 'CREATORS', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. '),
(3, 4, 'krug3.png', 'CONNECTORS', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. '),
(4, 4, 'krug4.png', 'CATALYSTS', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. ');
...
INSERT INTO `offices` (`offices_id`, `category_id`, `offices_continent`, `offices_image`, `offices_image_name`) VALUES
(1, 5, 'EMEA', 'U boji/podgorica.png', 'podgorica'),
(2, 5, 'EMEA', 'crno-bijelo/belgrade.png', 'belgrade'),
(3, 5, 'EMEA', 'crno-bijelo/brussels.png', 'brussels'),
(4, 5, 'EMEA', 'crno-bijelo/bucharest.png', 'bucharest'),
(5, 5, 'EMEA', 'crno-bijelo/dubai.png', 'dubai'),
(6, 5, 'EMEA', 'crno-bijelo/hamburg.png', 'hamburg'),
(7, 5, 'EMEA', 'crno-bijelo/istanbul.png', 'istanbul'),
(8, 5, 'EMEA', 'crno-bijelo/london.png', 'london'),
(9, 5, 'EMEA', 'crno-bijelo/madrid.png', 'madrid'),
(10, 5, 'EMEA', 'crno-bijelo/milano.png', 'milano'),
(11, 5, 'EMEA', 'crno-bijelo/moscow.png', 'moscow'),
(12, 5, 'EMEA', 'crno-bijelo/paris.png', 'paris'),
(13, 5, 'EMEA', 'crno-bijelo/riga.png', 'riga'),
(14, 5, 'EMEA', 'crno-bijelo/stockholm.png', 'stockholm');
...
--
ALTER TABLE `meetings`
  MODIFY `meeting_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `offices`
--
ALTER TABLE `offices`
  MODIFY `offices_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
